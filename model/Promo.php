...
class Promo extends Koneksi
{
  ...
  /**
   * Mengupdate status promo yang sudah melewati tanggal_selesai menjadi 'Nonaktif'
   *
   * @return void
   */
  public function autoUpdateStatus(): void
  {
    ...
    // Update semua promo yang aktif dan tanggal_selesai < hari ini
    $stmt = $this->conn->prepare("
    UPDATE promo 
    SET status = 'Nonaktif' 
    WHERE status = 'Aktif' AND tanggal_selesai < ?
  ");
  ...
  {
    return $this->getAllFromTable('promo');
  }
}
