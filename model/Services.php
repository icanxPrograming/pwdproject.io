...
class Services extends Koneksi
{
  private $conn;
  ...
  /**
   * Mengambil semua data services dengan status 'Aktif' dan urutan ASC.
   *
   * @return array<int, array<string, mixed>>
   */
  public function getAllServicesAsc($table): array
  {
    $this->validateTable($table);
  ...
  {
    return $this->getAllServicesAsc('services');
  }
}
