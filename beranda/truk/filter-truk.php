<div class="filter-box">
  ...
  <ul>
    ...
    $dataKategori = $kategori->getByJenis('truk');
  ...
  <h3>Merk</h3>
  <ul>
    <li><label><input type="checkbox" name="merk[]" value="Toyota"> Mitsubishi</label></li>
    <li><label><input type="checkbox" name="merk[]" value="Honda"> Hino</label></li>
    <li><label><input type="checkbox" name="merk[]" value="Honda"> Iveco</label></li>
  </ul>
