<div class="filter-box">
  ...
  <ul>
    ...
    $dataKategori = $kategori->getByJenis('alat_berat');
  ...
  <h3>Merk</h3>
  <ul>
    <li><label><input type="checkbox" name="merk[]" value="Toyota"> Caterpillar</label></li>
    <li><label><input type="checkbox" name="merk[]" value="Honda"> Komatsu</label></li>
  </ul>
