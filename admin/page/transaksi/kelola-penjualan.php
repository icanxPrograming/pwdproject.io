<h2 class="mt-4 mb-4"><i class="fas fa-hand-holding-usd"></i> Data Penjualan</h2>

<div class="row">
  <div class="col">
    <div class="mb-2">
      <a href="#" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data Penjualan</a>
    </div>
    <table class="table table-hover table-bordered">
      ...
      <tbody>
        <?php
        require_once('../model/Trans_Jual.php');
        $tran_jual = new Trans_Jual();
        $trans_jual = $tran_jual->getAll();
